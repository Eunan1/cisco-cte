 ...
 *
 * <p>The server terminal is the observability window for the three-terminal demo: the
 * interviewer watches registrations, queue depths and deliveries appear there. That wants
 * short, aligned, readable lines — which a logging framework's default format does not
 * give without configuration, and which is not worth a dependency here.
 *
...
public final class Log {
    ...
    private static void write(String level, String format, Object... args) {
        ...
        // interleaved half-lines would make the demo unreadable.
